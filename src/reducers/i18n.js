...
const vi = {
  ...
  whoweareShortDetail:
    "JS là một câu lạc bộ được thành lập với ý tưởng trở thành một cộng đồng cho sinh viên FU.",
  viewmore: "Xem thêm",
  ...
  detail201801Mobile:
    "Trong năm 2018, CLB JS đã tổ chức thành công sự kiện AMETHYST 2018 – Love and Passion.",
  detail201802Mobile:
    "Năm 2018, JS đồng thời tổ chức chuyến team building tại Bản Xôi, Ba Vì.",
  ...
  detail201601Mobile:
    "Trong năm 2016, JS Club lần đầu tiên tổ chức Coding Project.",
  detail201602Mobile:
    "Amethyst 2016 - Đêm prom đầu tiên của JS Club đã diễn ra thành công tốt đẹp.",
  detail201501Mobile:
  ...
  detail201502Mobile:
    "Những khoảnh khắc K11 để lại dấu chân tại gian hàng của JS tại Ngày hội các Câu lạc bộ.",
...
const en = {
  ...
  whoweareShortDetail:
    "JS is a club founded with the aim of being a community for FU students.",
  viewmore: "View more",
  ...
  detail201801Mobile:
    "In 2018, JS Club successfully organized AMETHYST 2018 – Love and Passion.",
  detail201802Mobile:
    "In 2018, JS also organized a team building trip at Ban Xoi, Ba Vi.",
  detail201701Mobile: "In 2017, JS successfully organized Coding Project 2017.",
  detail201702Mobile:
    "We also organized Prom – Awards Sapphire 2017.",
  detail201601Mobile:
    "In 2016, Coding Project was held for the first time.",
  detail201602Mobile:
    "Amethyst 2016 - JS Club's first prom night was organized with great success.",
  detail201501Mobile:
    "In semester Fall 2015, JS members had a team building trip to Mai Chau valley, Hoa Binh.",
  detail201502Mobile:
    "Moments of K11 students at JS Club's stall on Clubs Day.",
