...
class MembersDesktop extends Component {
  ...
  renderDetail() {
    ...
    if (this.state.menu === 0){
      ...
      return <Col span={18}><MembersList header={this.state.menu} array={array}/></Col>
    }
      ...
      return <Col span={18}><MembersList header={this.state.menu} array={ActiveMembersInJS}/></Col>
    }
  }
  ...
  render() {
    return (
      <Row>
        <Col style={{marginTop: "2%"}} span={6} ><MembersMenu changeDetail={this._changeDetail}/></Col>
        {this.renderDetail()}
      </Row>
    );
  }
