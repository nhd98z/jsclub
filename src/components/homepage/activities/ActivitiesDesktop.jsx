          ...
          {this.props.isScroll && (
            <div>
              <div className="container">
                ...
                >
                  <img className="imgActivities" src={ean02} alt="ean02" />
                  <div className="card">
                ...
                >
                  <img className="imgActivities" src={ean03} alt="ean03" />
                  <div className="card">
              ...
              <div className="container">
                ...
                >
                  <img className="imgActivities" src={ean04} alt="ean04" />
                  <div className="card">
                ...
                >
                  <img className="imgActivities" src={ean05} alt="ean05" />
                  <div className="card">
                ...
                <a className="item" href="https://www.facebook.com/fu.jsclub/posts/1549364328511411?__tn__=-R">
                  <img className="imgActivities" src={ean06} alt="ean06" />
                  <div className="card">
